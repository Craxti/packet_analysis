...
class PGSQLAuth(object):
    ...
    def __parse_server_data(self):
        ...
        for item in data_s2c_list:
            ...
            # The first four digits represent length + two digits represent major version number + two digits minor version number + name/value pair (separated by 00)
    ...
    def __split_pqsql_data(self, data):
        ...
        while offset < len_of_chrs:
            ...
            # Protocol format 1: The first byte indicates the command type, and the next four bytes indicate the length of the message, including itself
            # Protocol format 2: The first four bytes indicate the length of the message, including itself
