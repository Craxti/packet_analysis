...
def hexstr2ip(hex_str, byteorder="little"):
    """
    little byte order Store the low-order byte at the starting address
...
if __name__ == "__main__":
    ...
    if options.getlong2IP:
        print(ptions.getlong2IP, long2ip(options.getlong2IP, byteorder=options.byteOrder), options.byteOrder)
